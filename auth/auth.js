...
if (typeof supabase === 'undefined') {
    ...
    // Optionally, halt execution by throwing an error
...
if (registerForm) {
    ...
    registerForm.addEventListener("submit", async function (event) {
        ...
        if (!usernameInput || !departmentInput || !passwordInput) {
        ...
        /* =====================================================
           ...
           User does NOT enter an email.

           Supabase Auth still requires an email when using
           email/password authentication.

           This email is only used internally.
        ===================================================== */
...
if (loginForm) {
    ...
    loginForm.addEventListener("submit", async function (event) {
        ...
        try {
            ...
            /* =================================================
               USERNAME NOT FOUND (null or empty string)
            ================================================= */

            if (!usernameEmail || usernameEmail.trim() === "") {

                console.error(
                    "RPC returned NULL or empty for:",
                    username
                );
            ...
            if (
                role === "admin" &&
                department === "adult men"
            ) {

                window.location.href =
                    "../admin/adultMen/AM.html";
            ...
            if (
                role === "admin" &&
                department === "adult ladies"
            ) {

                window.location.href =
                    "../admin/adultLadies/AL.html";
            ...
            if (
                role === "admin" &&
                department === "young men"
            ) {

                window.location.href =
                    "../admin/youngMen/YM.html";
            ...
            if (
                role === "admin" &&
                department === "young ladies"
            ) {

                window.location.href =
                    "../admin/youngLadies/YL.html";
